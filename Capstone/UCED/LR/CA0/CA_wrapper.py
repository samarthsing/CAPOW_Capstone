    ...
    #        print ("   Constraint",c)
            ...
            if str(c) in ['Bal1Constraint','Bal2Constraint','Bal3Constraint','Bal4Constraint']:
                for index in cobject:
                     if int(index>0 and index<25 or day==days-1 and int(index>0 and index<49):
    #                print ("   Constraint",c)
                         try:
        ...
        for v in instance.component_objects(Var, active=True):
            ...
            if a=='mwh_1':
             ...
             for index in varobject:
               ...
               if int(index[1]>0 and index[1]<25 or day==days-1 and int(index>0 and index<49):
            ...
            if a=='flow':
             ...
             for index in varobject:
               if int(index[2]>0 and index[2]<25 or day==days-1 and int(index>0 and index<49):
